...
object NativeCascadeXTS {
     ...
     * @param key1 Primary keys (96 bytes): AES[0–31] | Twofish[32–63] | Serpent[64–95]
    ...
    /**
     * Decrypt sectors in-place (Serpent → Twofish → AES).
    ...
    /**
     * Encrypt sectors in-place (AES → Twofish → Serpent).
